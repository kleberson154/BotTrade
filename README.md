...
* **Execução Inteligente:** Utiliza ordens `Limit Post-Only` para garantir o recebimento de taxas de *maker* e evitar o *slippage*.
...
| LEVERAGE | Alavancagem para as operações | 3 |
